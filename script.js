...
var biografias = {
    ...
    bio06: {
        ...
        nome: "Rosa Parks", 
        bio: "Rosa Louise McCauley, mais conhecida por Rosa Parks, foi uma costureira negra norte-americana, símbolo do movimento dos direitos civis dos negros nos Estados Unidos. Ficou famosa, em 1º de dezembro de 1955, por ter-se recusado frontalmente a ceder o seu lugar no ônibus a um branco, tornando-se o estopim do movimento que foi denominado boicote aos ônibus de Montgomery e posteriormente viria a marcar o início da luta antissegregacionista.",
        citacao: "Você nunca deve ter medo do que está fazendo quando está certo",
    },
    bio07: {
        imagem: "https://hips.hearstapps.com/hmg-prod/images/a-portrait-of-harriet-tubman-ca-1820-1913-photo-by--corbis_corbis-via-getty-images.jpg",
        nome: "Harriet Tubman",
        bio: "Abolicionista Estadounidense. Lutou pela liberação de centenas de pessoas escravizadas, e conseguiu libertá-las.",
    },
};

var content = document.getElementById("content");

for (var minibio in biografias){
    content.innerHTML +=
        '<div class="card">' +
        '<img src=' + 
        biografias[minibio].imagem + '>' +
        '<details>' + '<summary>' +
        biografias[minibio].nome + '</summary>' +
        '<p>' + biografias[minibio].bio + '</p>' +
        '<blockquote>' + '<q>' + biografias[minibio].citacao + '</q></blockquote>'
        '</details> </div>';
};
